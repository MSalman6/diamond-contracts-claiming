...
exports.getTestBalances_dillution = exports.getTestBalances_DMD_with_prefix = exports.getTestBalances_DMD = exports.getTestBalances_DMD_cli_invalid_signature_size = exports.getTestBalances_DMD_cli = exports.getTestBalances_DMD_cli_same_address = exports.getTestBalances = void 0;
const ethers_1 = require("ethers");
function getTestBalances() {
    return [
...
exports.getTestBalances = getTestBalances;
...
function getTestBalances_DMD_cli_same_address() {
    let balances = [
...
exports.getTestBalances_DMD_cli_same_address = getTestBalances_DMD_cli_same_address;
// those balances have been created with a diamond-cli tool.
// example:
// ./diamond-cli getnewaddress
// ./diamond-cli signmessage "dDdaBZRTDiybXrPvYdvKdydjsnbG3kfd11" "0xEb44B81852A2705701A59D454d1a33DA7a71E169"
// IChOonnXj+Mq2aJcQF8cQ+ZUfF22DcNB0mdQAO9GxyObbVl5XJHniGHVkSRgZJZU3qIt7uLkmAtGJCuOByF/e6g=
function getTestBalances_DMD_cli() {
    let balances = [
...
exports.getTestBalances_DMD_cli = getTestBalances_DMD_cli;
// those balances have been created with a diamond-cli tool,
...
function getTestBalances_DMD_cli_invalid_signature_size() {
    let balances = [
...
exports.getTestBalances_DMD_cli_invalid_signature_size = getTestBalances_DMD_cli_invalid_signature_size;
function getTestBalances_DMD() {
...
exports.getTestBalances_DMD_with_prefix = getTestBalances_DMD_with_prefix;
...
function getTestBalances_dillution() {
    let dmd = (num) => {
        return ethers_1.ethers.formatUnits(ethers_1.ethers.parseEther(num), "wei");
    };
...
exports.getTestBalances_dillution = getTestBalances_dillution;
